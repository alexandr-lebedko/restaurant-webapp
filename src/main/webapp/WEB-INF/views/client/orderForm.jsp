                            ...
                            <table class="table border table-text-center">
                                ...
                                <c:forEach var="orderItem" items="${orderContent}" varStatus="status">
                                    ...
                                    <tr>
                                        ...
                                        <td>${orderItem.key.title.value.get(lang)}</td>
                                        <td>${orderItem.key.price.value}</td>
                                        <td><input class="border" name="${Attribute.ORDER_ITEM_QUANTITY}"
                                                   value="${orderItem.value}" type="number" min="1"/></td>
                                        <td><i class="fa fa-trash p-2 delete-row-button NEW" aria-hidden="true"></i>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
