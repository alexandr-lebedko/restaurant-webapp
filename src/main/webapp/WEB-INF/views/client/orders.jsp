    ...
    <div class="container main-content">
        <div class="row justify-content-end">
            <div class="col-lg-8 unselectable">
                ...
                <table class="table border table-bordered table-text-center">
                    ...
                    <c:forEach var="order" items="${requestScope.get(Attribute.ORDERS)}">
                        ...
                        <tr>
                            <td>
                                <a class="badge badge-info" href="${orderUrl}">${order.id}</a>
                            </td>

                            <td>
                                <a class="badge badge-info" href="${invoiceUrl}">${order.invoice.id}</a>
                            </td>
