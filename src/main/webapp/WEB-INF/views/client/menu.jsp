...
<t:page pageUrl="${pageUrl}">
    <div class="container main-content">
        <div class="row justify-content-between">
            ...
            <div class="col-lg-8" id="items">
                <div class="row">
                    <c:forEach var="item" items="${requestScope.get(Attribute.ITEMS)}">
                        <c:url var="imageUrl" value="${URL.IMAGE_PREFIX.concat(item.pictureId)}"/>
                        <c:url var="addToBucketUrl" value="${URL.CLIENT_ITEM_ADD}"/>

                        <div class="col-lg-3">
                            <div class="card item-card"
                                 onclick="post('${addToBucketUrl}', {'${Attribute.ITEM_ID}': '${item.id}'})">
