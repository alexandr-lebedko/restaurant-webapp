...
public class ClientModifyOrderCommand implements Command {
    private static final ResponseAction CLIENT_ORDER_REDIRECT = new RedirectAction(URL.CLIENT_ORDER_FORM);
